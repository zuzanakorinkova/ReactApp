		...
		<Stack.Navigator>
			<Stack.Screen
				...
				options={{
					headerRight: () => (
						<Button
							onPress={() => navigation.navigate("Search Chat")}
							type="clear"
							icon={
								<Ionicons name="ios-create-outline" size={25} color="#4f52a0" />
							}
						/>
					),
		...
		<Stack.Navigator>
			<Stack.Screen
				...
				options={{
					headerRight: () => (
						<Button
							onPress={() => navigation.navigate("All Clubs")}
							type="clear"
							icon={
								<Ionicons name="ios-add-outline" size={25} color="#4f52a0" />
							}
						/>
					),
					headerStyle: { backgroundColor: "#fff" },
